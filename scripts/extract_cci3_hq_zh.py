#!/usr/bin/env python3
"""Extract a 450 MB CCI3-HQ Chinese sample for tokenizer training.
...
Run:
    python scripts/extract_cci3_hq_zh.py
"""
...
CONFIG = DatasetConfig(
    label="CCI3-HQ Chinese",
    dataset_name="BAAI/CCI3-HQ",
    subset=None,
    split="train",
    url="https://huggingface.co/datasets/BAAI/CCI3-HQ",
    licenses=("CCI3-HQ User Agreement",),
    default_output=(
        PROJECT_ROOT / "dataset" / "tokenizer_corpus" / "cci3_hq_zh_450mb.jsonl"
    ),
    default_target_mb=450.0,
    default_shuffle_buffer=20_000,
    default_min_chars=200,
    default_max_chars=200_000,
    gated_access_hint=(
        "CCI3-HQ requires approval and authentication. First open\n"
        "  https://huggingface.co/datasets/BAAI/CCI3-HQ\n"
        "and accept the conditions, then run:\n"
        "  hf auth login"
    ),
)
...
if __name__ == "__main__":
    raise SystemExit(
        main(CONFIG, "Stream 450 MB of CCI3-HQ Chinese into tokenizer-ready JSONL.")
    )
