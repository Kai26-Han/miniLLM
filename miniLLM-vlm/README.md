...
[Back to the miniLLM project](../README.md)
...
miniLLM-vlm is the vision-language extension of [miniLLM](../README.md). It reuses a trained miniLLM Base model and a SigLIP vision encoder, aligning image features with language embeddings through a lightweight Projector. This enables the originally text-only miniLLM to understand single images, describe visual content, answer questions about images, and conduct multi-turn image-text conversations.
...
Both Visual Pretraining and Visual SFT were completed with the following hardware. The default training settings were designed around this resource profile:

| Item | Configuration |
| --- | --- |
| GPU | 1 × NVIDIA GeForce RTX 4090 |
| Training setup | Single machine, single GPU |

## ⚙️ Scope and Limitations

- The current implementation and default settings target single-machine, single-GPU experiments
